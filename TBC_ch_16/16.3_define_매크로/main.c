...
/*
	Preprocessor directives befins with # symbol at the beginning of a line.
*/
...
/*
	Object-like macros vs Funcion-like macros
...
#define SIX 2*3
//#undef SIX
#define SIX 2 * 3		// Warning undef한 후 다시 define하면 warning사라짐.
