...
int main()
{
	/*
		...
		- Left shift
		number << n : multiply number by 2^n(not always)

		- Right shift
		number >> n : divide by 2^n (for non-negative numbers) (not always)
	*/
	...
	//Note: the signed result is machine dependant(비주얼스튜이오, 리눅스 둘다 signed의 앞부분 1로 채움.)
